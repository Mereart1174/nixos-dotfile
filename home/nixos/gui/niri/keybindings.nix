  ...
  programs.niri.config =
    ...
    [
      (plain "binds" [
        ...
        (plain "Alt+Shift+Return" [ (leaf "spawn" [ "alacritty" ]) ])
        (plain "Mod+O" [ (leaf "spawn" [ "anyrun" ]) ])
        ...
        (plain "Mod+Alt+Left" [ (flag "move-column-left") ])
        (plain "Mod+Alt+Down" [ (flag "move-window-down") ])
        (plain "Mod+Alt+Up" [ (flag "move-window-up") ])
        (plain "Mod+Alt+Right" [ (flag "move-column-right") ])
